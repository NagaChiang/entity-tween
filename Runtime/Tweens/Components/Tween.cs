...
namespace Timespawn.EntityTween.Tweens
{
    public struct Tween : IBufferElementData, ITweenId
    {
        ...
        internal Tween(EaseType easeType, byte easeExponent, float duration, bool isPingPong, byte loopCount, double elapsedTime, int chunkIndex) : this()
        {
            EaseType = easeType;
            ...
            Id = GenerateId(elapsedTime, chunkIndex);
        }

        internal Tween(TweenParams tweenParams, double elapsedTime, int chunkIndex)
            : this(tweenParams.EaseType, tweenParams.EaseExponent, tweenParams.Duration, tweenParams.IsPingPong, tweenParams.LoopCount, elapsedTime, chunkIndex)
        {
        }
        ...
        private int GenerateId(double elapsedTime, int entityInQueryIndex)
        {
            unchecked
            {
